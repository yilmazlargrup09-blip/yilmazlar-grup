    ...
    <section className="py-16 bg-white dark:bg-gray-900 bg-[url('/assets/services/bg-12.svg')] dark:bg-[url('/assets/services/hizmetler-bg.svg')] bg-cover bg-center">
      <div className="container mx-auto px-4">
        ...
        {servicesList.map((service, index) => (
          <motion.div
          key={service.title}
          className="bg-white dark:bg-gray-700 rounded-lg p-6 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-300 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all"
        ...
        >
          ...
          {/* <Link href={service.href} className="text-red-500 hover:text-red-400 transition-colors duration-300">
            {translations.cta} &rarr;
          </Link> */}
        </motion.div>
          ))}
        </div>
